...
exports.less = new Transformer({
  ...
  async: function(str, options, cb) {
    ...
    if (self.cache(options))
      return cb(null, self.cache(options));
    if (options.filename) {
...
exports.sass = new Transformer({
  ...
  sync: function(str, options) {
    try {
      ...
      if (options.filename)
        ex.message += ' in ' + options.filename;
      throw ex;
    }
  }
});
  ...
  async: function(str, options, cb) {
    ...
    builder.build(function(err, obj) {
      if (err)
        ...
        return cb(null, self.cache(options, obj.require + obj.js));
    });
  }
});
  ...
  async: function(str, options, cb) {
    ...
    builder.build(function(err, obj) {
      if (err)
        ...
        return cb(null, self.cache(options, obj.css));
    });
  }
});
